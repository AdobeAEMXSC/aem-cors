 ...
 */
package com.adobe.aem.graphmeshdemo.core.models;
...
import com.adobe.aem.graphmeshdemo.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "graphqlMeshDemo/components/helloworld");
